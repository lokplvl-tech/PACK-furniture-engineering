...
> Источник: `06-sota/datum-mebel-epistemic-standard.md` §2 (внутренний стандарт «Датум Мебель»)
...
**Methods performed**:
- [FE.M.006](../03-methods/FE.M.006.md) — монтаж гарнитура у клиента (L1+L2 → L3), физическая сборка вне CAD-конвейера
...
- Логистика - доставка готовых деталей и фурнитуры на объект клиента (подтверждено пилотом, 2026-07-27)
