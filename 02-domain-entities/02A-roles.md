...
**Definition**: Агент коммерческого и административного контура. Ведёт клиента от заявки до передачи заказа на производство: заводит карточку клиента, администрирует заказ в «Базис-Салон», применяет расчёт погонажа для определения цены, собирает обязательный пакет документов и выгружает заказ в производство.
