...
### Категория 3: Коммерческий расчёт (роль [FE.R.006](02A-roles.md#fe-r-006) Менеджер)

| ID | Method Name | Produces | Status |
|----|-------------|----------|--------|
| [FE.M.003](../03-methods/FE.M.003.md) | Расчёт погонажа кухонного гарнитура | строка в FE.WP.001 | active |

### Категория 4: Интерфейс семейства «Базис» — не формализован
...
### Категория 5: Монтаж (роль [FE.R.003](02A-roles.md#fe-r-003) Монтажник)

| ID | Method Name | Produces | Status |
|----|-------------|----------|--------|
| [FE.M.006](../03-methods/FE.M.006.md) | Монтаж гарнитура у клиента (L1+L2 → L3) | Собранный гарнитур L3 (без карточки WP) | active |

### Категория 6: Визуализация (роль [FE.R.001](02A-roles.md#fe-r-001) Дизайнер-конструктор)

| ID | Method Name | Produces | Status |
|----|-------------|----------|--------|
| [FE.M.007](../03-methods/FE.M.007.md) | Фотореалистичная визуализация изделия для клиента | FE.WP.003 | active |
...
| FE.M.005 | Разрешение проектных коллизий (цикл АДИ) | Проектирование | FE.WP.002 (условно) | hypothesis |
| FE.M.006 | Монтаж гарнитура у клиента (L1+L2 → L3) | Монтаж | Собранный гарнитур L3 | current |
| FE.M.007 | Фотореалистичная визуализация изделия для клиента | Визуализация | FE.WP.003 | current |
...
| [FE.WP.002](../04-work-products/FE.WP.002.md) (Метка согласованного отклонения) | FE.M.005 (создаёт), FE.M.006 (может потребовать - несовпадение выреза с фактической разводкой на объекте) |
| [FE.WP.003](../04-work-products/FE.WP.003.md) (Фотореалистичное изображение изделия) | FE.M.007 (создаёт) |
