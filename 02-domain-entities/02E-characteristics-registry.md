...
**Открытое расхождение (2026-07-26):** третий, синтезированный источник (`06-sota/kitchen-systems-engineering-playbook.md`) формулирует границу жёстче — «ПВШ только для гардеробных, для кухонь строго направляющие скрытого монтажа под дно ящика». Не противоречит впрямую (узкая ниша под духовым шкафом остаётся узкой нишей), но стоит уточнить у практика: используется ли ПВШ в кухонных проектах компании вообще, или упоминание в §4 источника ONEON — это фурнитура для смежных гардеробных модулей той же кухни, а не для кухонных ящиков как таковых. Не разрешено в этой итерации.
