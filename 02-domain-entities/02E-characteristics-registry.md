...
**Расхождение найдено веб-поиском (2026-07-27), не разрешено:** вторичные дизайнерские источники (не ГОСТ, не первичная практика компаний) называют диапазон 1200-1650 мм для прохода между рядами — заметно шире 900 мм. Не переписываю значение `evidence`-уровня (кросс-валидировано двумя компаниями) второсортным источником — фиксирую расхождение для пилота: возможно, 900 мм — минимально допустимое (для однорядной/узкой кухни), а 1200-1650 мм — рекомендация для комфортного прохода при двухстороннем открывании фасадов с обеих сторон одновременно (другое практическое условие, не то же самое измерение). Требует уточнения у пилота или сверки первичного текста источника, не силами одного веб-поиска.
