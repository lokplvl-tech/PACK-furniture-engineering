...
|------|---------|------------|
| Tools | Инструменты (семейство «Базис»: Базис-Салон/Мебельщик/Шкаф и др., Раскрой, ЧПУ, Смета, Склад, Салон, Упаковка) | `02-domain-entities/02D-tools-index.md`, не base-kind генератора |
